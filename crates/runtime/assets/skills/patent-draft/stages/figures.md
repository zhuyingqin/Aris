# Stage: `figures` — Figure Descriptions and Reference Numerals

Process user-provided technical diagrams and assign reference numerals. Unlike
`/paper-figure`, which generates data plots, this stage only describes figures
...
1. **Read the image** using `read_file` (it renders image files)
