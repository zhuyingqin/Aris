...
- `REVIEWER_MODEL = configured reviewer` — External reviewer for specification quality
...
- If `LlmReview` is not available, skip cross-model review and note it in the output.
