...
export const RELEASES_URL = "https://somni.chat/releases/v0.4.69/SomniQ.Studio_0.4.69_x64-setup.exe";
export const GITHUB_RELEASES_URL = "https://github.com/zhuyingqin/Aris/releases/tag/v0.4.69";
...
const zh = {
  ...
  pricing: {
    ...
    comparisonSubtitle: "每月 ¥79，即送 $50 刀官方 Token 额度池，自由调度 GPT、MiniMax、DeepSeek",
  ...
  auth: {
    ...
    userAgreementConsent: "我已阅读并同意",
    userAgreementLink: "《用户服务协议》",
    userAgreementRequired: "请先阅读并勾选同意《用户服务协议》",
...
const en: Copy = {
  ...
  pricing: {
    ...
    comparisonSubtitle: "For ¥79 per month, get a $50 USD monthly Token quota pool to use across GPT, MiniMax, and DeepSeek",
  ...
  auth: {
    ...
    userAgreementConsent: "I have read and agree to the",
    userAgreementLink: "User Service Agreement",
    userAgreementRequired: "Please read and accept the User Service Agreement before signing up.",
  ...
  dashboard: {
    ...
    tierFree: "Standard compute account",
    tierPro: "Higher quota account",
...
export const es: Copy = {
  ...
  pricing: {
    ...
    comparisonSubtitle: "Por ¥79 al mes, obtén un fondo mensual de $50 USD en Tokens para GPT, MiniMax y DeepSeek",
  ...
  auth: {
    ...
    userAgreementConsent: "He leído y acepto el",
    userAgreementLink: "Acuerdo de servicio",
    userAgreementRequired: "Lee y acepta el Acuerdo de servicio antes de registrarte.",
  ...
  dashboard: {
    ...
    tierFree: "Cuenta estándar",
    tierPro: "Cuenta de mayor cuota",
