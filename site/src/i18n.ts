...
export const RELEASES_URL = "https://somni.chat/releases/v0.4.52/SomniQ.Studio_0.4.52_x64-setup.exe";
export const GITHUB_RELEASES_URL = "https://github.com/zhuyingqin/Aris/releases/tag/v0.4.52";
...
const zh = {
  ...
  pricing: {
    ...
    lede: "一个订阅即可解锁一站式科研工作流与每月充足的顶尖大模型算力包，赋能研究从文献检索、实验运行到成稿审查全流程。",
    price: "¥79",
    priceLabel: "/ 月",
    badge: "Pro",
    planName: "SomniQ Studio 专业版",
    planDescription: "本地优先的自主科研工作台 · 含大模型额度",
    includesTitle: "包含全部核心能力与专属额度",
    includes: [
      "每月充裕的大模型额度（包含 DeepSeek / MiniMax / GPT 等顶尖模型）",
      "全流程科研：文献检索、实验运行、论文撰写与 16 步独立审查",
      "三层长效科研记忆与本地文献库管理",
      "开箱即用，无需自行申请或配置复杂 API Key",
      "100% 本地隐私安全，资料与记忆完全留在本机",
    ],
    ...
    details: [
      {
        title: "充裕的每月模型额度",
        body: "订阅内含充足的 AI 词元额度，轻松支撑海量文献综述、自动化代码实验与论文独立审查。",
      },
      {
        title: "顶尖多模型智能协同",
...
const en: Copy = {
  ...
  pricing: {
    ...
    title: "Ready-to-use research workspace with built-in model quota",
    lede: "One monthly subscription provides a complete autonomous research workflow alongside generous monthly top-tier AI model credits.",
    price: "200 Pesos",
    priceLabel: "/ month",
    badge: "Pro",
    planName: "SomniQ Studio Pro",
    planDescription: "Local-first autonomous research workspace with AI quota",
    includesTitle: "Everything core is included",
    includes: [
      "Generous monthly AI model credit quota (DeepSeek, MiniMax, GPT & more)",
      "Full research workflows: literature search, experiments, writing & 16-step review",
      "Three-layer long-term research memory & local citation library",
      "Ready to use out of the box with zero API key configuration needed",
      "100% local privacy: all papers, data & memory stay on your machine",
    ],
...
export const es: Copy = {
  ...
  pricing: {
    ...
    title: "Espacio de investigación listo para usar con cuota de modelos incluida",
    lede: "Una sola suscripción mensual proporciona el flujo completo de investigación autónoma junto con generosos créditos mensuales para modelos de IA de primer nivel.",
    price: "200 Pesos",
    priceLabel: "/ mes",
    badge: "Pro",
    planName: "SomniQ Studio Pro",
    planDescription: "Espacio de investigación autónoma local-first con cuota IA",
    includesTitle: "Todo lo esencial está incluido",
    includes: [
      "Generosa cuota mensual de créditos de modelos IA (DeepSeek, MiniMax, GPT y más)",
      "Flujos de investigación completos: búsqueda bibliográfica, experimentos, redacción y revisión de 16 pasos",
      "Memoria de investigación de tres niveles y biblioteca local de citas",
      "Listo para usar sin necesidad de configurar claves API",
      "Privacidad 100% local: todos los artículos, datos y memoria quedan en tu equipo",
    ],
