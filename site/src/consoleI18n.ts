...
export const consoleZh: ConsoleCopy = {
  ...
  plan: {
    heroTitle: "套餐与科研订阅管理",
    subgreetingActive: "查看当前算力额度与集群权限，并单独查询自动续费签约状态。",
    ...
    activeMemberPro: "千研科研 Pro 算力账户",
    activeSomniqPro: "SomniQ 算力账户",
    statusActiveRunning: "● 算力可用",
...
export const consoleEn: ConsoleCopy = {
  ...
  plan: {
    ...
    subgreetingActive: "View your compute quota and cluster access, then check auto-renewal separately.",
    subgreetingUnsubscribed: "Choose the best research AI compute subscription for yourself or your laboratory.",
    tagActivePro: "Compute account active",
    tagCurrentFree: "Current: Free Tier",
    tagClusterGroup: (g: string) => `Group: ${g}`,
    tagDefaultGroup: "Default",
    tagBalance: (b: string) => `Balance: ${b}`,
    activeMemberPro: "Thousand Research Pro compute account",
    activeSomniqPro: "SomniQ compute account",
    statusActiveRunning: "● Quota available",
    ...
    subscribeNowBtn: "Ask about Thousand Research Pro",
...
export const consoleEs: ConsoleCopy = {
  ...
  plan: {
    ...
    subgreetingActive: "Consulta tu cuota de cómputo y acceso al clúster; verifica la renovación automática por separado.",
    ...
    tagActivePro: "Cuenta de cómputo activa",
    ...
    activeMemberPro: "Cuenta de cómputo Pro de investigación",
    activeSomniqPro: "Cuenta de cómputo SomniQ",
    statusActiveRunning: "● Cuota disponible",
    ...
    subscribeNowBtn: "Consultar el plan Pro de investigación",
