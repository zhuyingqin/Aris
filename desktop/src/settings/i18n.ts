...
const EN_NAV_KEYWORDS = {
  ...
  remote: "remote control phone pairing qr",
...
export const SETTINGS_COPY: Record<Language, SettingsCopy> = {
  cn: {
    general: {
      ...
      groupLabel: "后台分组",
      groupHint: "切换后会更新 New API 后台里当前账号的分组，并重新同步额度与模型。",
      groupSave: "保存分组",
      groupSaving: "保存中...",
      groupLoading: "正在加载分组...",
      groupEmpty: "暂无可选分组",
  ...
  en: {
    general: {
      ...
      groupHint: "Saving updates this account's group in New API, then refreshes quota and models.",
