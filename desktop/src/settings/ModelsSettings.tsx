        ...
        <div className="sp-advanced-body">
          {canConfigureExecutor && (
            <div className="sp-adv-section">
              ...
              <div className="sp-adv-rows">
                <div className="st-row"><div className="st-row-label"><span className="st-label">{copy.fieldModel}</span>{!advForm.executorModel && <span className="st-hint">{copy.executorModelHint}</span>}</div><div className="st-row-control"><PresetTextInput value={advForm.executorModel ?? ""} placeholder={advExecMeta.defaultModel || "claude-sonnet-4-6"} options={advExecMeta.models ?? EXECUTOR_MODELS} onChange={(value) => { resetOpState(); setAdvForm((current) => ({ ...current, executorModel: value })); }} /></div></div>
          ...
          {canConfigureReviewerApi && (
            <div className="sp-adv-section">
              ...
              {advReviewerProvider !== "" && (
                <div className="sp-adv-rows">
                  <div className="st-row"><div className="st-row-label"><span className="st-label">{copy.fieldModel}</span>{!advForm.reviewerModel && <span className="st-hint">{copy.reviewerModelHint}</span>}</div><div className="st-row-control"><PresetTextInput value={advForm.reviewerModel ?? ""} placeholder={advReviewerMeta.defaultModel || "gpt-5.5"} options={advReviewerMeta.models ?? REVIEWER_MODELS} onChange={(value) => { resetOpState(); setAdvForm((current) => ({ ...current, reviewerModel: value })); }} /></div></div>
